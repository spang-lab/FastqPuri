...
for (i in 1:30) { 
   ...
   trimmed1 <- c(0, 0, sample(10000:20000,1), sample(1000:2000,1))
   trimmed2 <- c(0, 0, sample(10000:20000,1), sample(1000:2000,1))
   ...
   writeBin(as.integer(trimmed1),f)
   writeBin(as.integer(trimmed2),f)
